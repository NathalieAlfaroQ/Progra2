    ...
    for (int j = columnas - 1; j >= 0; j--) {
      ...
      if (matriz[i][j] != 0) {
        ...
        if (i - 3 >= 0) {
          ...
          if (comprobar == matriz[i - 1][j] && comprobar == matriz[i - 2][j] &&
              comprobar == matriz[i - 3][j]) {
            return true;
          }  // End if
        }    // End if
        ...
        if (j - 3 >= 0) {
          comprobar = matriz[i][j];
          // Comprobando las 4 fichas seguidas.
          if (comprobar == matriz[i][j - 1] && comprobar == matriz[i][j - 2] &&
              comprobar == matriz[i][j - 3]) {
            return true;
          }  // End if
        }    // End if
      ...
      if (matriz[i][j] != 0) {
        ...
        if (j - 3 >= 0) {
          ...
          if (comprobar == matriz[i][j - 1] && comprobar == matriz[i][j - 2] &&
              matriz[i][j - 3] == 0) {
            return j - 3;
          } else if (comprobar == matriz[i][j - 1] && matriz[i][j - 2] == 0 &&
                     comprobar == matriz[i][j - 3]) {
            return j - 2;
          } else if (matriz[i][j - 1] == 0 && comprobar == matriz[i][j - 2] &&
                     comprobar == matriz[i][j - 3]) {
            return j - 1;
          }  // End if
        }    // End if
        ...
        if (i - 3 >= 0 && j - 3 >= 0) {
          ...
          // Comprobando las 4 fichas seguidas.
          if (comprobar == matriz[i - 1][j - 1] &&
              comprobar == matriz[i - 2][j - 2] && matriz[i - 3][j - 3] == 0) {
            return j - 3;
